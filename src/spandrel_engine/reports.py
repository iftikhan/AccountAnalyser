...
from spandrel_engine.util import get_accounts_by_company_name, get_all_accounts
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if not accounts:
            ...
            worksheet = workbook.add_sheet('AssimilationEngineReport')
                    ...
                    'attachments': [
                        {
                            ...
                            'title': 'Assimilation Engine Reports',
